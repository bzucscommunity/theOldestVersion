...
public class ViewTopicPost extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    List<Post> posts;
    List<User> users;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postMoreMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu popup = new PopupMenu(ViewTopicPost.this, v);
                MenuInflater inflater = popup.getMenuInflater();
                popup.setOnMenuItemClickListener(ViewTopicPost.this);;
        ...
        PostClickView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    addComment();
                    Intent intent=new Intent(getApplicationContext(),ViewTopicPost.class);
