...
public class ViewSearchPost extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    List<Post> posts;
    List<User> users;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postMoreMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PopupMenu popup = new PopupMenu(ViewSearchPost.this, v);
                MenuInflater inflater = popup.getMenuInflater();
                popup.setOnMenuItemClickListener(ViewSearchPost.this);
        ...
        PostClickView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    addComment();
                    Intent intent=new Intent(getApplicationContext(),ViewSearchPost.class);
            ...
            public void onClick(View v) {
                try {
                    if(favorite.equals(R.drawable.ic_baseline_favorite_24)) {
                        removeFromFavorites();
                        Toast.makeText(ViewSearchPost.this, "Removed from Favorites!", Toast.LENGTH_LONG).show();
                    }else if(favorite.equals(R.drawable.ic_baseline_favorite_border_24)){
                        addToFavorites();
                        Log.d("TAG", "onClick: hithere");
                        Toast.makeText(ViewSearchPost.this, "Added to Favorites!", Toast.LENGTH_LONG).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.delete_post:
                deletePost();
                Toast.makeText(ViewSearchPost.this, "Post Deleted!", Toast.LENGTH_SHORT).show();
