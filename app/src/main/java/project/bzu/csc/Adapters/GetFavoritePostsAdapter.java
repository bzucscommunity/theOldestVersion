...
import project.bzu.csc.Activities.ViewFavoritePost;
...
public class GetFavoritePostsAdapter extends RecyclerView.Adapter<GetFavoritePostsAdapter.ViewHolder> {
    ...
    public GetFavoritePostsAdapter(Context context, List<Post> posts){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(context, ViewFavoritePost.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.putExtra("postIDFromFavorite",posts.get(position).getPostID());
